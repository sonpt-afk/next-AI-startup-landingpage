  ...
  return (
    ...
    >
      ...
      <div className="container relative mt-16">
        <h1 className="text-6xl sm:text-[100px] md:text-[168px] md:leading-none bg-white	font-semibold tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,white,white,rgb(74,32,138,.5))] text-transparent bg-clip-text text-center">
          AI SEO
        </h1>
